package com.carl.judge.service.impl;
...
import com.carl.judge.constant.CommonConstant;
import com.carl.judge.exception.ThrowUtils;
import com.carl.judge.mapper.AppMapper;
import com.carl.judge.model.dto.app.AppQueryRequest;
import com.carl.judge.model.entity.App;
import com.carl.judge.model.entity.User;
import com.carl.judge.model.enums.AppScoringStrategyEnum;
import com.carl.judge.model.enums.AppTypeEnum;
import com.carl.judge.model.enums.ReviewStatusEnum;
import com.carl.judge.model.vo.AppVO;
import com.carl.judge.model.vo.UserVO;
import com.carl.judge.service.AppService;
import com.carl.judge.service.UserService;
import com.carl.judge.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(enumByValue1 == null, ErrorCode.PARAMS_ERROR, "应用类型不合法");
            AppScoringStrategyEnum enumByValue2 = AppScoringStrategyEnum.getEnumByValue(scoringStrategy);
            ThrowUtils.throwIf(enumByValue2 == null, ErrorCode.PARAMS_ERROR, "评分策略不合法");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
        if (StringUtils.isNotBlank(appName)) {
            ThrowUtils.throwIf(appName.length() > 80, ErrorCode.PARAMS_ERROR, "应用名称过长，应小于80个字符");
        }
        if(reviewStatus != null){
            ReviewStatusEnum enumByValue = ReviewStatusEnum.getEnumByValue(reviewStatus);
            ThrowUtils.throwIf(enumByValue == null, ErrorCode.PARAMS_ERROR, "审核状态不合法");
        }
